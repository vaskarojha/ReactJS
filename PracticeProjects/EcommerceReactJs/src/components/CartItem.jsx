      ...
      <div className='w-full min-h-[150px] flex items-center gap-x-4'>
        ...
        <div className='w-full flex flex-col'>
          ...
          <div className=' flex gap-x-2 h-[36px] text-sm'>
            <div className='flex felx-1 max-w-[100px] items-center h-full border text-primary font-medium'>
              <div onClick={()=> decreaseAmount(id)} className='flex-1 h-1 full flex justify-center items-center cursor-pointer'><span>-</span></div>
              
            <div className='h-full flex justify-center items-center px-2'>{amount}</div>
            <div onClick={()=> increaseAmount(id)} className='flex-1 h-1 full flex justify-center items-center cursor-pointer' ><span>+</span></div>
            </div>
